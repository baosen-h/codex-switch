...
Talking is the standard structure for migrating large legacy pages into feature modules.
...
Keep new prompt or chat UI designs behind feature-owned integration components first. Promote only stable primitives to `components/ui` after their API is proven reusable outside Talking.
