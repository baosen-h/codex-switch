...
<table>
  <tr>
    <th colspan="2" align="center">Codex CLI 视觉模型支持</th>
  </tr>
  <tr>
    <td width="50%"><img src="docs/images/codex-vision-support-request.png" alt="在 Codex CLI 中向 DeepSeek 发送图片" width="100%" /></td>
    <td width="50%"><img src="docs/images/codex-vision-support-result.png" alt="DeepSeek 通过 MiMo-V2.5 理解图片" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><sub>在 Codex CLI 中向纯文本 DeepSeek 模型发送图片。</sub></td>
    <td align="center"><sub>MiMo-V2.5 提供图片信息，使 DeepSeek 能够回答。</sub></td>
  </tr>
</table>
