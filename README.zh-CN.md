...
<table>
  ...
  <tr>
    <td><img src="docs/images/codex-vision-support-request.png" alt="在 Codex CLI 中向 DeepSeek 发送图片" width="100%" /></td>
    <td><img src="docs/images/codex-vision-support-result.png" alt="DeepSeek 通过 MiMo-V2.5 理解图片" width="100%" /></td>
  </tr>
  <tr>
